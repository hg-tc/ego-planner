...
namespace ego_planner
{
  ...
  public:
    ...
    bool BsplineOptimizeTrajRebound(Eigen::MatrixXd &optimal_points, double ts, ros::Publisher *Optimizedata_pub_); // must be called after initControlPoints()
  ...
  private:
    ...
    bool rebound_optimize(ros::Publisher *Optimizedata_pub_);
