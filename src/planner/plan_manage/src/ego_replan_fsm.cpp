...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    Optdata_client = nh.serviceClient<lbfgs::Optdata>("/lbfgs/Optdata");
  ...
  void EGOReplanFSM::setaftersubCallback(const Optimizedata::ConstPtr &msg)
  {
    ...
    ROS_INFO("variable_num_ data shows %d", variable_num_);
    planner_manager_->setdata(result, variable_num_, q, final_cost);
    // data transform
